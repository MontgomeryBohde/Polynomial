...
std::vector<double> Polynomial::roots(double real_threshold){
...
std::vector<double> Polynomial::roots(double lb, double ub, double real_threshold){
...
std::vector<double> Polynomial::budans_roots(double lb, double ub, int newton_iter, double precision){
...
Polynomial Polynomial::integ(double lbnd) {
...
double Polynomial::integ(double lb, double ub) {
...
std::vector<double> Polynomial::solve(double num){
...
double Polynomial::solve(double num, double lb, double ub, int newton_iter){
